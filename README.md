...
- ✅ Total Problems Solved: **229/229**
- 📈 Difficulty Breakdown: Easy(73) / Medium(135) / Hard(21) / Total(229)
...
- [🚀 LeetCode Training Progress](#-leetcode-training-progress)
  ...
  - [🗂️ Problem Categories](#️-problem-categories)
    ...
    - [🧱 Stack \& Queue (Total: 13 problems)](#-stack--queue-total-13-problems)
...
| 0342 | [Power Of Four](https://leetcode.com/problems/power-of-four/) | Easy | [Runtime(100%)](./cpp/bit_manipulation/0342_power_of_four/) | Check power of two + odd bit position → `n & 0x55555555` |
...
| 0476 | [Number Complement](https://leetcode.com/problems/number-complement/) | Easy | [Runtime(100%)](./cpp/bit_manipulation/0476_number_complement/) | Build bitmask of 1s to match bit-length → `~num & mask` gives complement |
| 0693 | [Binary Number With Alternating Bits](https://leetcode.com/problems/binary-number-with-alternating-bits/) | Easy | [Runtime(100%)](./cpp/bit_manipulation/0693_binary_number_with_alternating_bits/) | Check alternating bit pattern using bitwise properties |
...
| 0376 | [Wiggle Subsequence](https://leetcode.com/problems/wiggle-subsequence/) | Medium | [Runtime(100%)](./cpp/greedy/0376_wiggle_subsequence/) | Greedy → track `up` / `down` to count alternating differences |
...
| 0769 | [Max Chunks To Make Sorted](https://leetcode.com/problems/max-chunks-to-make-sorted/) | Medium | [Runtime(100%)](./cpp/greedy/0769_max_chunks_to_make_sorted/) | Greedy + prefix max: when `cur_max == i`, one chunk can be cut |
| 0870 | [Advantage Shuffle](https://leetcode.com/problems/advantage-shuffle/) | Medium | [Runtime(~99%)](./cpp/greedy/0870_advantage_shuffle/) | use largest to beat largest, otherwise sacrifice smallest |
...
| 0217 | [Contains Duplicate](https://leetcode.com/problems/contains-duplicate/) | Easy | [Runtime(~70%)](./cpp/hash_map/0217_contains_duplicate/) | Hash set / O(n) scan |
...
| 0594 | [Longest Harmonious Subsequence](https://leetcode.com/problems/longest-harmonious-subsequence/) | Easy | [Runtime(>80%)](./cpp/hash_map/0594_longest_harmonious_subsequence/) | Frequency hash map / check consecutive numbers |
...
| # | Title | Difficulty | Solution Folder | Notes |
|:---:|:---:|:---:|:---:|:---:|
| 0023 | [Merge K Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists/) | Hard | [Runtime(sometimes 100%)](./cpp/heap_quickselect_bucket/0023_merge_k_sorted_lists/) | min-heap (priority queue) |
...
| 0218 | [The Skyline Problem](https://leetcode.com/problems/the-skyline-problem/) | Hard | [Runtime(~100%)](./cpp/heap_quickselect_bucket/0218_the_skyline_problem/) | sweep line + max-heap (priority queue) |
...
| 0470 | [Implement Rand10() Using Rand7()](https://leetcode.com/problems/implement-rand10-using-rand7/) | Medium | [Runtime(vary a lot)](./cpp/math/0470_implement_rand10_using_rand7/) | Use **rejection sampling**: generate 1–49 via `(rand7()-1)*7+rand7()`, keep ≤40 and map to 1–10 |
...
| 0303 | [Range Sum Query Immutable](https://leetcode.com/problems/range-sum-query-immutable/) | Easy | [Runtime(100%)](./cpp/prefix_sum/0303_range_sum_query_immutable/) | Prefix sum with O(1) range query |
...
| 0560 | [Subarray Sum Equals K](https://leetcode.com/problems/subarray-sum-equals-k/) | Medium | [Runtime(~50%)](./cpp/prefix_sum/0560_subarray_sum_equals_k/) | Prefix sum + hash map to count matching prefix differences |
...
| 0636 | [Exclusive Time Of Functions](https://leetcode.com/problems/exclusive-time-of-functions/) | Medium | [Runtime(100%)](./cpp/stack_queue/0636_exclusive_time_of_functions/) | Stack / Function call simulation |
...
| 0028 | [Find The Index Of The First Occurrence In A String](https://leetcode.com/problems/find-the-index-of-the-first-occurrence-in-a-string/) | Easy | [Runtime(100%)](./cpp/string_processing/0028_find_the_index_of_the_first_occurrence_in_a_string/) | KMP algorithm + LPS array + O(m+n) |
...
| 0437 | [Path Sum III](https://leetcode.com/problems/path-sum-iii/) | Medium | [Runtime(100%)](./cpp/tree_dp_path_sum/0437_path_sum_iii/) | DFS + Prefix Sum + HashMap |
...
| 0144 | [Binary Tree Preorder Traversal](https://leetcode.com/problems/binary-tree-preorder-traversal/) | Easy | [Runtime(100%)](./cpp/tree_traversal/0144_binary_tree_preorder_traversal/) | Iterative DFS using stack, Root→Left→Right |
...
| 0019 | [Remove Nth Node From End Of List](https://leetcode.com/problems/remove-nth-node-from-end-of-list/) | Medium | [Runtime(100%)](./cpp/two_pointers/0019_remove_nth_node_from_end_of_list/) | Two pointers with dummy head / Fixed gap (n+1) / One pass |
...
| 0696 | [Count Binary Substrings](https://leetcode.com/problems/count-binary-substrings/) | Easy | [Runtime(100%)](./cpp/two_pointers/0696_count_binary_substrings/) | Track consecutive 0/1 groups / Single pass O(n) / Constant space |
